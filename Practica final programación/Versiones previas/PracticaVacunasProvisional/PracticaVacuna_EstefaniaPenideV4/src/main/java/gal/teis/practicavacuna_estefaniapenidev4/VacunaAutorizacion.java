...
//atributos
    ...
    //En lugar de LocalDate pruebo a usar LOcalDateTime ya que un programa
    //donde las variables sólo están almacenadas mientras se ejecuta, si se
    //autorizan o rechazan vacunas será en el mismo día y si también se muestra la hora
    //se podrá apreciar mejor su funionamiento.
...
//setters y getters de las fases
