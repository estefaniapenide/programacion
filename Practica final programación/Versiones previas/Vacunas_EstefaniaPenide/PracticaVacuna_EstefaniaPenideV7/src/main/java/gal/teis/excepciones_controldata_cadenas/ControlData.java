...
/**
 * Métodos estáticos para controlar los tipos introducidos mediante Scanner
 * @author Estefania
 */
...
/**
    ...
    public static double leerDouble(Scanner sc) {
        ...
        do {
            ...
            System.out.println("ERROR. You have not entered a valid value. Please enter another number:" );
                }
            sc.next();
            correcto=false;
            }
    ...
    public static boolean leerBoolean(Scanner sc) {
        ...
        do {
            ...
            System.out.println("ERROR. You have not entered a valid value. Please enter 'true' or 'false':" );
                }
            sc.next();
            correcto=false;
            }
