...
public class Cadenas {
    ...
    public static String menuGestionVacunas() {
        ...
        if (idioma.equals("esp")) {
            ...
            menu = "-------------------------------------------------\n"
                    ...
                    + "7. Show authorized vaccines. \n"
                    + "8. Show rejected vaccines. \n"
                    + "9. Show vaccines pending to authorize / reject. \n"
                    + "10. Show latest research phase for each stored vaccine. \n\n"
                    + "0. Exit.";
        }
        return menu;
    }
    ...
    /**
     * Devuelve un String del menú de búsqueda con las opciones a elegir de todas
     * las búsquedas que se peuden hacer con el programa.
     *
    ...
    /**
     * Devuelve un String del título de la opción del menú de búsqueda que se le indica.
     *
     * @param opcion
    ...
    /**
     * Devuelve un String con el mensaje "La vacuna no se encunetra en la lista";
     *
    ...
    /**
     * Devuelve un String con el mensaje "Vacuna no reemplazada."
     *
    ...
    public static String vacunaReemplazada() {
        ...
        if (idioma.equals("esp")) {
            ...
            mensaje = "Vacuna no reemplazada.";

        } else if (idioma.equals("eng")) {

            mensaje = "The vaccine has not been replaced.";
        }
        return mensaje;
    }
