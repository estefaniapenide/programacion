...
//setters las fases
    ...
    public String ultimaFaseImplementada() {
        ...
        if (idioma.equals("esp")) {
            ...
            switch (fasesCompletadas) {
                case 0:
                    implementacion = "No phase has been evaluated.";
                    break;
                case 1:
                    if (!fase1Superada) {
                        implementacion = "Last evaluated phase = Phase 1\n"
                                + "Result: Not passed";
                    } else if (fase1Superada) {
                        implementacion = "Last evaluated phase = Phase 1\n"
                                + "Result: Passed";
                ...
                case 2:
                    if (!fase2Superada) {
                        implementacion = "Last evaluated phase = Phase 2\n"
                                + "Result: Not passed";
                    } else if (fase2Superada) {
                        implementacion = "Last evaluated phase = Phase 2\n"
                                + "Result: Passed";
                ...
                case 3:
                    if (!fase3Superada) {
                        implementacion = "Last evaluated phase = Phase 3\n"
                                + "Result: Not passed";
                    } else if (fase3Superada) {
                        implementacion = "Last evaluated phase = Phase 3\n"
                                + "Result: Passed";
